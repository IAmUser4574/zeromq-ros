...
class AbstractZone(LMCPObject.LMCPObject):
    ...
    def __init__(self):
        ...
        self.AffectedAircraft = []   #uint32
        self.StartTime = 0   #real64
        self.EndTime = 0   #real64
    ...
    def pack(self):
        ...
        buffer.append(struct.pack(">I", self.ZoneID))
        ...
        buffer.append(struct.pack(">d", self.StartTime))
        buffer.append(struct.pack(">d", self.EndTime))
    ...
    def unpack(self, buffer, _pos):
        ...
        _pos += 2
        if _arraylen > 0:
            self.AffectedAircraft = struct.unpack_from(">" + `_arraylen` + "I", buffer, _pos )
            _pos += 4 * _arraylen
        self.StartTime = struct.unpack_from(">d", buffer, _pos)[0]
        _pos += 8
        self.EndTime = struct.unpack_from(">d", buffer, _pos)[0]
        _pos += 8
