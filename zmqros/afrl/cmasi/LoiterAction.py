...
from cmasi import LoiterDirection
from cmasi import Location3D


class LoiterAction(VehicleAction.VehicleAction):
    ...
    def pack(self):
        ...
        buffer.append(struct.pack(">f", self.Duration))
    ...
    def unpack(self, buffer, _pos):
        ...
        _pos += 4
        self.Duration = struct.unpack_from(">f", buffer, _pos)[0]
        _pos += 4
