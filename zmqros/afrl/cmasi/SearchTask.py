...
from cmasi import WavelengthBand
...
class SearchTask(Task.Task):
    ...
    def pack(self):
        ...
        buffer.append(struct.pack(">f", self.DwellTime))
    ...
    def unpack(self, buffer, _pos):
        ...
        if _arraylen > 0:
            ...
            _pos += 4 * _arraylen
        self.DwellTime = struct.unpack_from(">f", buffer, _pos)[0]
        _pos += 4
