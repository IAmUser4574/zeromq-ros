...
#from lmcp import *
from cmasi import SimulationStatusType
...
class SessionStatus(LMCPObject.LMCPObject):
    ...
    def pack(self):
        ...
        buffer.append(struct.pack(">d", self.ScenarioTime))
    ...
    def unpack(self, buffer, _pos):
        ...
        _pos += 8
        self.ScenarioTime = struct.unpack_from(">d", buffer, _pos)[0]
        _pos += 8
