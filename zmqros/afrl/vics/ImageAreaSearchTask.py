...
from vics import AreaSearchStrategy


class ImageAreaSearchTask(AreaSearchTask.AreaSearchTask):

    def __init__(self):
        AreaSearchTask.AreaSearchTask.__init__(self)
        self.LMCP_TYPE = 10
        ...
        self.SearchStrategy = AreaSearchStrategy.AreaSearchStrategy.ParallelSweep   #AreaSearchStrategy
    ...
    def pack(self):
        ...
        """
        buffer = []
        buffer.extend(AreaSearchTask.AreaSearchTask.pack(self))
    ...
    def unpack(self, buffer, _pos):
        ...
        """
        _pos = AreaSearchTask.AreaSearchTask.unpack(self, buffer, _pos)
    ...
    def toString(self):
        ...
        """
        buf = AreaSearchTask.AreaSearchTask.toString(self)
        buf += "From ImageAreaSearchTask:\n"
    ...
    def toXMLStr(self, ws):
        str = ws + "<ImageAreaSearchTask>\n";
        #str +=AreaSearchTask.AreaSearchTask.toXMLMembersStr(self, ws + "  ")
    ...
    def toXMLMembersStr(self, ws):
        buf = ""
        buf += AreaSearchTask.AreaSearchTask.toXMLMembersStr(self, ws)
        buf += ws + "<SearchStrategy>" + AreaSearchStrategy.get_AreaSearchStrategy_int(self.SearchStrategy) + "</SearchStrategy>\n"
