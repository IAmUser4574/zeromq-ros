...
class ImagePointSearchTask(PointSearchTask.PointSearchTask):

    def __init__(self):
        PointSearchTask.PointSearchTask.__init__(self)
        self.LMCP_TYPE = 12
    ...
    def pack(self):
        ...
        """
        buffer = []
        buffer.extend(PointSearchTask.PointSearchTask.pack(self))
    ...
    def unpack(self, buffer, _pos):
        ...
        """
        _pos = PointSearchTask.PointSearchTask.unpack(self, buffer, _pos)
    ...
    def toString(self):
        ...
        """
        buf = PointSearchTask.PointSearchTask.toString(self)
        buf += "From ImagePointSearchTask:\n"
    ...
    def toXMLStr(self, ws):
        str = ws + "<ImagePointSearchTask>\n";
        #str +=PointSearchTask.PointSearchTask.toXMLMembersStr(self, ws + "  ")
    ...
    def toXMLMembersStr(self, ws):
        buf = ""
        buf += PointSearchTask.PointSearchTask.toXMLMembersStr(self, ws)
